...
!-----------------------------------------------------------------------
    ...
    CONTAINS
        ...
        ! An initialization method is required to associated the pointer
        ! with a particular variable:
        PROCEDURE, PUBLIC  :: initialize => init_shadow_scalar
    END TYPE
...
!-----------------------------------------------------------------------
! Method definitions for rpe_type subclasses:
!-----------------------------------------------------------------------
    ...
    SUBROUTINE init_shadow_scalar (this, x)
        CLASS(rpe_shadow),                INTENT(OUT) :: this
...
!-----------------------------------------------------------------------
    ...
    ! Reduce the precision of a real number.
    !
