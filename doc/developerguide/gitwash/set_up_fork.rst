...
#. Clone your fork to the local computer with ``git clone
   git@github.com:your-user-name/rpe.git``
#. Investigate.  Change directory to your new repo: ``cd rpe``. Then
   ...
   Now you want to connect to the upstream `rpe github`_ repository, so
...
main `rpe`_ repository at `rpe github`_.
