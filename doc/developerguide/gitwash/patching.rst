...
Then, send the generated patch files to the `rpe
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `rpe mailing list`_.
...
Fork the `rpe`_ repository on github |emdash| :ref:`forking`.
Then::
